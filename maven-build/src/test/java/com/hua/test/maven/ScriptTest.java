...
public final class ScriptTest extends BaseTest {
	...
	public void testCall() {
		try {
			System.out.println(ProjectUtil.getAbsolutePath("/doc", true));
	...
	public void testTemp() {
		try {
			String command = "ping 127.0.0.1";
			command = "mvn install:install-file -Dfile=D:\\workspace\\java\\maven3\\doc\\jar\\common-0.0.2-sources.jar -DgroupId=com.hua -DartifactId=common -Dversion=0.0.2 -Dpackaging=jar -Dclassifier=sources";
			final Runtime rt = Runtime.getRuntime();
			Process ps = rt.exec(command);
			BufferedReader br = new BufferedReader(new InputStreamReader(ps.getInputStream(), Constant.CHART_SET_GB2312));
			StringBuffer sb = new StringBuffer();
